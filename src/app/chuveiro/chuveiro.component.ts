...
@Component({
  ...
  styleUrls: ['./chuveiro.component.css']
})
export class ChuveiroFileComponent implements OnInit {
  ...
  ngOnInit() {
     ...
     const optionsCompletedTasksChuveiro: any = {
      ...
      var consumoMensal = new Chartist.Line('#consumoMensal', dataCompletedTasksChuveiro, optionsCompletedTasksChuveiro);
      ...
      var optionswebsiteViewsChuveiro = {
          axisX: {
              showGrid: false
          },
          low: 0,
      ...
      var websiteViewsChart = new Chartist.Bar('#websiteViewsChart', datawebsiteViewsChuveiro, optionswebsiteViewsChuveiro, responsiveOptions);
